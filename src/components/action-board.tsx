...
const audioFileNames = ['celebration.mp3', 'check.mp3', 'ding.mp3', 'pencil.mp3', 'play.mp3', 'retro.mp3', 'flourish.mp3', 'game.mp3', 'grow.mp3', 'tick.mp3', 'clink.mp3', 'tap.mp3', 'woosh.mp3'];
